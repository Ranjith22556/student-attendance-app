          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl">Studance</h1>
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  {status === "authenticated" ? (
                    <Button className="w-full py-5 text-base md:py-6 md:text-lg" asChild>
                      <Link href="/dashboard">Go to Dashboard</Link>
                    </Button>
                  ) : status === "loading" ? (
                    <Button className="w-full py-5 text-base md:py-6 md:text-lg" disabled>
                      Loading...
                    </Button>
                  ) : (
                    <Button
                      onClick={handleGoogleSignIn}
                      className="w-full flex items-center justify-center gap-2 py-5 text-base md:py-6 md:text-lg"
                      variant="outline"
                    >
              ...
              <div className="mx-auto grid max-w-screen-sm gap-4 grid-cols-1 sm:grid-cols-2">
                <Card>
